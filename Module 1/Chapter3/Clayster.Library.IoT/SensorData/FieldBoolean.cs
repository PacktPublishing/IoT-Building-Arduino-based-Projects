...
namespace Clayster.Library.IoT.SensorData
{
	...
	public class FieldBoolean : Field
	{
		...
		public FieldBoolean(string NodeId, string FieldName, int StringId, DateTime Timepoint, bool Value, ReadoutType Type)
		...
		/// <param name="Value">Value</param>
		/// <param name="Type">Type of value.</param>
		public FieldBoolean(string NodeId, string FieldName, int[] StringIds, DateTime Timepoint,
			bool Value, ReadoutType Type)
		...
		/// <param name="Value">Value</param>
		/// <param name="Type">Type of value.</param>
		public FieldBoolean(string NodeId, string FieldName, int StringId, string LocalizationSeed,
			DateTime Timepoint, bool Value, ReadoutType Type)
		...
		/// <param name="Value">Value</param>
		/// <param name="Type">Type of value.</param>
		public FieldBoolean(string NodeId, string FieldName, int[] StringIds, string LocalizationSeed,
			DateTime Timepoint, bool Value, ReadoutType Type)
		...
		/// <param name="Value">Value</param>
		/// <param name="Type">Type of value.</param>
		/// <param name="Status">Field status.</param>
		public FieldBoolean(string NodeId, string FieldName, FieldLanguageStep[] StringIds, 
			DateTime Timepoint, bool Value, ReadoutType Type, FieldStatus Status)
		...
		public FieldBoolean(string NodeId, string FieldName, int StringId, DateTime Timepoint,
			bool Value, ReadoutType Type, string LanguageModule)
		...
		/// not specified, or if empty or null, the language module of the metering library will be used.</param>
		public FieldBoolean(string NodeId, string FieldName, int StringId, string LocalizationSeed,
			DateTime Timepoint, bool Value, ReadoutType Type, string LanguageModule)
		...
		public FieldBoolean(string NodeId, string FieldName, int StringId, DateTime Timepoint,
			bool Value, ReadoutType Type, FieldStatus Status)
		...
		/// not specified, or if empty or null, the language module of the metering library will be used.</param>
		public FieldBoolean(string NodeId, string FieldName, int StringId, string LocalizationSeed,
			DateTime Timepoint, bool Value, ReadoutType Type, FieldStatus Status, string LanguageModule)
		...
		{
			return new FieldBoolean(this.NodeId, this.FieldName, this.StringIDs, this.Timepoint, this.value, 
		...
		{
			w.WriteAttributeString("value", this.value ? "true" : "false");
		}
		...
		{
			FieldBoolean F = obj as FieldBoolean;
			if (F == null)
				return false;
