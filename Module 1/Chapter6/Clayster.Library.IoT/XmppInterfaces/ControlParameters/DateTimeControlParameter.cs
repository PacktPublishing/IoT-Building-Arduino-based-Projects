...
{
	/// <summary>
	/// Class handling a DateTime-valued control parameter.
	/// </summary>
	/// <remarks>
	/// © Clayster, 2014
	/// 
	/// Author: Peter Waher
	/// </remarks>
	public class DateTimeControlParameter : ControlParameter<DateTime>
	{
		...
		public DateTimeControlParameter (string Name, GetMethod<DateTime> GetMethod, SetMethod<DateTime> SetMethod, string Title, string Description, DateTime Min, DateTime Max)
		...
		public override string Import (string Value)
		{
			...
			if (!XmlUtilities.TryParseDateTimeXml (Value, out NewValue))
