...
namespace Clayster.Library.IoT.XmppInterfaces.ControlParameters
{
	...
	/// Author: Peter Waher
	/// </remarks>
	public class DoubleControlParameter : ControlParameter<double>
	{
		...
		{
			return XmlUtilities.DoubleToString(Value);
		}
		...
		public override string Import (string Value)
		{
			...
			if (!XmlUtilities.TryParseDouble (Value, out NewValue))
