  ...
  else
{
  ...
  uint16_t jpglen = cam.frameLength();
    ...
    // Set Choreo inputs
    String APIKeyValue = "0c62beaa12xxxxxxxxxxxfce3845ca";
    UploadChoreo.addInput("APIKey", APIKeyValue);
    String AccessTokenValue = "72157655651xxxxxx-xxxxxxa84d7b8e01";
    UploadChoreo.addInput("AccessToken", AccessTokenValue);
    String AccessTokenSecretValue = "d95e8xxxxxddb7";
    UploadChoreo.addInput("AccessTokenSecret", AccessTokenSecretValue);
    String APISecretValue = "7277dxxxxxxd696";
